...
namespace FitnessApp.SqlServer
{
    public static class Database
    {
        ...
        private static readonly ApplicationDatabaseContext _database = new ApplicationDatabaseContext();
        ...
        {
            _database.User.Add(new UserModel()
            {
                FirstName = firstName,
                LastName = lastName,
                Email = email,
        ...
        public static List<ChallengeModel> GetAllChallenges(int accountID)
        {
            ...
            // {
            //     ChallengeModel temp = new ChallengeModel((int)dataReader["PK_ChallengeID"]);
            //
